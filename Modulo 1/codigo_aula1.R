#Posso afirmar que o intercepto representa o ponto em que a reta corta o eixo das ordenadas e B
#é o coeficiente angular que representa o quanto varia a média de Y para um aumento de uma unidade de X?
